...
namespace CustomerLibCore.Data.IntegrationTests.Repositories.EF
{
	...
	public class NoteRepositoryTest
	{
		...
		[Fact]
		public void ShouldCreateNoteRepositoryWithOptions()
		{
			var options = DbContextOptionsHelper.CustomerLibDbContextOptions;

			var repo = new NoteRepository(options);
		...
		public class NoteRepositoryFixture
		{
			...
			{
				var repo = new NoteRepository(DbContextOptionsHelper.CustomerLibDbContextOptions);
