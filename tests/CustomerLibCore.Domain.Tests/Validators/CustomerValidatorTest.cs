...
//		{
//			var propertyName = nameof(Customer.FirstName);
...
//		{
//			var propertyName = nameof(Customer.LastName);
//			var customer = CustomerValidatorFixture.MockCustomer();
...
//		{
//			var propertyName = nameof(Customer.PhoneNumber);
//			var customer = CustomerValidatorFixture.MockCustomer();
...
//		{
//			var propertyName = nameof(Customer.Email);
//			var customer = CustomerValidatorFixture.MockCustomer();
...
//			Assert.Equal($"{propertyName}[0].{nameof(Address.Line)}", error.PropertyName);
...
//			Assert.Equal($"{propertyName}[0].{nameof(Note.Content)}", error.PropertyName);
//			Assert.Equal(ValidationErrorMessages.REQUIRED, error.ErrorMessage);
//		}

//		#endregion

//		#region Details properties RuleSet

//		[Fact]
//		public void ShouldValidateCustomerDetailsRuleSet()
//		{
//			// Given
//			var customer = CustomerValidatorFixture.MockCustomer();

//			// Make non-Details properties invalid.
//			customer.Addresses = null;
//			customer.Notes = null;

//			// When
//			var resultDetailsRuleSet = _customerValidator.Validate(
//				customer, options => options.IncludeRuleSets("Details"));

//			var fullErrors = _customerValidator.ValidateFull(customer).Errors;

//			// Then
//			Assert.True(resultDetailsRuleSet.IsValid);

//			Assert.Equal(2, fullErrors.Count);

//			AssertContainPropertyNames(fullErrors, new[]
//			{
...
//		[Fact]
//		public void ShouldInvalidateCustomerDetailsRuleSet()
//		{
//			// Given
...
//				customer, options => options.IncludeRuleSets("Details")).Errors;
...
//			AssertContainPropertyNames(basicDetailsRuleSetErrors, new[]
//			{
